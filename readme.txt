...
3、1005. K 次取反后最大化的数组和（https://leetcode-cn.com/problems/maximize-sum-of-array-after-k-negations/）
4、976. 三角形的最大周长（https://leetcode-cn.com/problems/largest-perimeter-triangle/）
5、1323. 6 和 9 组成的最大数字（https://leetcode-cn.com/problems/maximum-69-number/）
6、1403. 非递增顺序的最小子序列（https://leetcode-cn.com/problems/minimum-subsequence-in-non-increasing-order/）
